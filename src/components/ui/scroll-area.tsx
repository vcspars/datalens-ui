...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      "flex touch-none select-none transition-all duration-200 ease-out hover:bg-muted/30",
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-border hover:bg-primary/60 transition-colors duration-200" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
